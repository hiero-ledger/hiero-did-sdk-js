...
import { DIDRemoveServiceMessage, DIDRemoveServiceMessageHederaDefaultLifeCycle } from '../../../src';
...
describe('Default DIDRemoveServiceMessage Lifecycle', () => {
  describe('when processing a valid DIDRemoveServiceMessage', () => {
    ...
    beforeEach(async () => {
      ...
      const runner = new LifecycleRunner(DIDRemoveServiceMessageHederaDefaultLifeCycle);
