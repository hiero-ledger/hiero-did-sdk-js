...
*   link:https://github.com/hiero-ledger/hiero-sdk-js[Hiero JavaScript SDK]: The official Hiero JavaScript SDK, used for interacting with the Hedera network.
*   link:https://docs.hedera.com[Hedera docs]: Official documentation for Hedera.

== Next Steps

*   **Essential Components:** Learn about the essential components and functions of the Hiero DID SDK in the xref::03-implementation/guides/essential-components-guide.adoc[Essential Components Guide].
