...
The Hashgraph DID SDK provides the `VaultVerifierFactory` class within its `verifier-hashicorp-vault` package. For further details, refer to the xref:04-deployment/packages/index.adoc[`@hiero-did-sdk-js/verifier-hashicorp-vault`] package documentation.
