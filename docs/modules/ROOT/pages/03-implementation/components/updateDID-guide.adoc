...
* xref:03-implementation/components/updateDID-api.adoc[`updateDID` API Reference]
* xref:03-implementation/components/did-update-builder-api.adoc[`DIDUpdateBuilder` API Reference]
* xref:03-implementation/components/generateUpdateDIDRequest-api.adoc[`generateUpdateDIDRequest` API Reference]
* xref:03-implementation/components/submitUpdateDIDRequest-api.adoc[`submitUpdateDIDRequest` API Reference]
