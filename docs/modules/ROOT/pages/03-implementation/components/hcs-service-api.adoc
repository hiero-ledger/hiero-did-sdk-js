...
The class diagram below illustrates the core methods of the `HederaHcsService` interface for working with Hedera Consensus Service (HCS).

image::hcs-service-class-diagram.png[]
