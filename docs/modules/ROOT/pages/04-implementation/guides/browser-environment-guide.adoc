...
To fix that you can pass your own `TopicReader` implementation to the Registrar and Resolver. This will allow you to use a different transport protocol, like REST API to fetch messages from the Hedera network.
