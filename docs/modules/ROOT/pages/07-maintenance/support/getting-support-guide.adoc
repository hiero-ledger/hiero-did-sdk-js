...
If you encounter any bugs, unexpected behavior, or have suggestions for improvements, please report them through the link:https://github.com/DSRCorporation/hiero-did-sdk-js/issues[GitHub Issues] page. When reporting an issue, please provide as much detail as possible, including:
...
If you have questions about the Hashgraph DID SDK, you can ask them through the link:https://github.com/DSRCorporation/hiero-did-sdk-js/discussions[GitHub Discussions] page. This is a great place to engage with the community and get help from other users and developers.
...
Please adhere to the link:https://github.com/DSRCorporation/hiero-did-sdk-js/blob/main/CODE_OF_CONDUCT.md[Code of Conduct] when interacting with the community. Be respectful and considerate of others, and avoid any offensive or discriminatory language.
