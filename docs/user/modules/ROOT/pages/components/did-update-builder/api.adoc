...
* xref:components/update-did/guide.adoc#build-did-update-operation[Build a DID Update operation]
...
Returns::
A list of xref:components/update-did/api.adoc#type-did-update-operation[DIDUpdateOperation] objects representing the changes to the DID document.
