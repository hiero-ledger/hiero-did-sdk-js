...
The Hashgraph DID SDK provides a `updateDID` function within its core package. For further details, refer to the xref:packages/core/guide.adoc[`@hashgraph-did-sdk-js/core`] package documentation.
