...
*  `publicKey(): MultibasePublicKey`: Returns the public key of the publisher, used for functionalities like controlling access to the DID Document and authenticating update operations.
