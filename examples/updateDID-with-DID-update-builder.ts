...
const did =
  'did:hedera:testnet:RTHEmJFVw6fPPkUuFhL5f8j8ShFrVvtUcZuVq3k2pWR_0.0.5217512'; // Replace with the DID you want to update
...
async function main() {
  try {
    ...
    console.log(
      `Updated DID Document: ${JSON.stringify(didDocument, null, 2)}`,
    );
  } catch (error) {
